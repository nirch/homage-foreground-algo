...
int		pt2d_approximate_line_pv( pt2dA_type *apt, int i0, int i1, vec2f_type *p, vec2f_type *v, float *d );
...
struct pln_type *	pt2dA_bounding_contour( pt2dA_type *apt );
	...
	// Pt2dGroupV.c
pt2dGroupA_type *	pt2dA_group_v( pt2dA_type *apt, float d );
pt2dGroupA_type *	pt2dA_group_v1( pt2dA_type *apt, float d );
