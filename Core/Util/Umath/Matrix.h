...
matrix_type *	matrix_alloc( int ni, int nj, int type );
...
matrix_type *		matrix_multiply( matrix_type *A, matrix_type *B, matrix_type *C );

int		matrixD_multV( matrix_type *A, double *B, double *C );
int		matrixD_multVF( matrix_type *A, float *B, float *C );


void	matrix_multiply_scalar( matrix_type *A, double s, matrix_type *B );

void	matrixD_get_column( matrix_type *m, int j, double f[] );
void	matrixD_set_column( matrix_type *m, int j, double f[] );
void	matrixD_set_columnF( matrix_type *m, int j, float f[] );


int		matrix_read_file( matrix_type **A, char *file );

//int		matrix_write( matrix_type *A, char *file );
int	matrix_write_file( matrix_type *m, char *file );

int	matrix_write( matrix_type *m, FILE *fp );
...
void	matrixD_symmetric( matrix_type *mt );
...
void	matrixD_diagonal( double *A, int m, int n, double *D, int p );
	...
	// MatrixSvd.c
int	matrixD_svd( matrix_type *A, matrix_type **U, matrix_type **W, matrix_type **V );
...
int	matrixSD_eigen( matrix_type *m, matrix_type *em, double ev[] );
