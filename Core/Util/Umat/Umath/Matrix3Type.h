...
void	matrix3_multV( matrix3_type *m, vec3d *b, vec3d *c );
...
void	matrix3_column( matrix3_type *m, int j, vec3d_type *c );
...
void	matrix3_to_quaternion( matrix3_type *m, double q[] ); // w  x  y   z
