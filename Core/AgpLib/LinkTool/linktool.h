...
void	linkL_connect_s( vec2f_type *ctr, link_type  *link, vec2f_type *ctr1, link_type  *link1, float T );
...
void linkL_set_depth( link_type *link, float depth );

void linkL_set_adepth( link_type *link, float adepth[] );
void linkL_get_adepth( link_type *link, float **adepth );
...
link_type *	linkL_copy( link_type *plink, link_type *elink, int fPr );


int	linkL_copy_sub( vec2d *pctr, link_type *plink, float gt0, float gt1, 
...
struct ln_type *	link_to_ln( link_type *link );
