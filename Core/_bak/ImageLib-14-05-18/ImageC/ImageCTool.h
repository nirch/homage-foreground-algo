...
image_type *	imageC_from_image1( image_type *im, int d, image_type *imc );
...
image_type *	imageC_r( image_type *sim, image_type *im );

image_type *	imageC_i( image_type *sim, image_type *im );
