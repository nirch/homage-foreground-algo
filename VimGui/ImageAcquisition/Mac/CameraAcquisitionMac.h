...
#define HANDSET_IPAD_4              10
#define HANDSET_IPAD_5              11
...
public:
	...
	int		OpenWithPreview( int iCamera = 0, CGRect *previewLayerRect = NULL);
...
protected:
    char* platformString();         // must delete the returned value after using
